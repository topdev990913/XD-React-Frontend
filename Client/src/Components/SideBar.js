...
const SideBar = () => {
    return (
        <div className="SideBar_out">
            <Row>
                <svg id="apps" xmlns="http://www.w3.org/2000/svg" width="40.876" height="40.876" viewBox="0 0 40.876 40.876" style={{ marginTop: "39px" }}>
            ...
            <Row>
                <svg id="user-bolt" xmlns="http://www.w3.org/2000/svg" width="43.011" height="43.011" viewBox="0 0 43.011 43.011" style={{ marginTop: "35px" }}>
            ...
            <Row>
                <svg id="target-arrow" xmlns="http://www.w3.org/2000/svg" width="40.847" height="40.847" viewBox="0 0 40.847 40.847" style={{ marginTop: "35px" }}>
            ...
            <Row>
                <svg id="star" xmlns="http://www.w3.org/2000/svg" width="40.51" height="40.51" viewBox="0 0 40.51 40.51" style={{ marginTop: "35px" }}>
            ...
            <Row>
                <svg id="logout" xmlns="http://www.w3.org/2000/svg" width="40.51" height="40.51" viewBox="0 0 40.51 40.51" style={{ marginTop: "35px" }}>
